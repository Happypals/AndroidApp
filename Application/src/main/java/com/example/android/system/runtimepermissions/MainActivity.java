...
public class MainActivity extends SampleActivityBase
    ...
    /**
     * My code
     * Id to identify a calendar permission request.
     */
    ...
    private static String[] PERMISSION_CALENDAR = {Manifest.permission.READ_CALENDAR,
    ...
    /**
     * Called when the 'show calendar' button is clicked.
     * Callback is defined in resource layout definition.
     */
    ...
    private void requestCalendarPermissions() {
        // BEGIN_INCLUDE(canlendar_permission_request)
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            // For example, if the request has been denied previously.
            Log.i(TAG,
                    "Displaying calendar permission rationale to provide additional context.");

            // Display a SnackBar with an explanation and a button to trigger the request.
            Snackbar.make(mLayout, R.string.permission_canlendar_rationale,
                    Snackbar.LENGTH_INDEFINITE)
                    .setAction(R.string.ok, new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
            ...
            ActivityCompat.requestPermissions(this, PERMISSION_CALENDAR,
                    REQUEST_CALENDAR);
        }
        // END_INCLUDE(canlendar_permission_request)
    }
    ...
    private void showCalendarDetails() {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.sample_content_fragment, CalendarFragment.newInstance())
                .addToBackStack("calender")
                .commit();
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA) {
            ...
            if (PermissionUtil.verifyPermissions(grantResults)) {
                // All required permissions have been granted, display contacts fragment.
                Snackbar.make(mLayout, R.string.permision_available_calendar,
                        Snackbar.LENGTH_SHORT)
                        .show();
            } else {
                Log.i(TAG, "Contacts permissions were NOT granted.");
